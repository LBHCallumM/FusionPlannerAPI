...
namespace FusionPlannerAPI.Migrations
{
    ...
    [Migration("20230402104242_ReAddColumnIdDisplayOrderConstraintToCard")]
    partial class ReAddColumnIdDisplayOrderConstraintToCard
    {
            ...
            modelBuilder.Entity("FusionPlannerAPI.Infrastructure.Card", b =>
                {
                    ...
                    b.HasIndex("ColumnId", "DisplayOrder")
                        .IsUnique()
                        .HasDatabaseName("ix_cards_column_id_display_order");
